...
model = model_from_json(open(r'E:\project\webCamEmocognizer\models\Face_model_architecture.json').read())
#model.load_weights('_model_weights.h5')
model.load_weights(r'E:\project\webCamEmocognizer\models\Face_model_weights.h5')
...
def detect_face(frame):
        #cascPath = r'E:\project\webCamEmocognizer\models\haarcascade_frontalface_default.xml'
