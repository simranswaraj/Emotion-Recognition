...
X_train = np.load(r'E:\project\webCamEmocognizer\data\Scaled.bin.npy')
Y_tr_labels = np.load(r'E:\project\webCamEmocognizer\data\labels.bin.npy')
...
model.save_weights(r'E:\project\webCamEmocognizer\models\Face_model_weights.h5')
open(r'E:\project\webCamEmocognizer\models\Face_model_architecture.json', 'w').write(json_string)
model.save_weights(r'E:\project\webCamEmocognizer\models\Face_model_weights.h5')
